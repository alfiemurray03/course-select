# Sousa Murray eLearning learner file storage

Sousa Murray eLearning supports manual learner entry without any additional Cloudflare binding.
...
3. In the Sousa Murray eLearning Pages project, add an R2 bucket binding:
   - Variable name: `LEARNER_UPLOADS`
   - R2 bucket: `aptenvo-learner-uploads`
4. Redeploy the latest Sousa Murray eLearning production deployment.
...
- The file is written to the private R2 bucket under the Sousa Murray eLearning order ID.
