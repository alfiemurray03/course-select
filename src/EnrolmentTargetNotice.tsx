...
export default function EnrolmentTargetNotice() {
  return <section className="section enrolment-target-section"><div className="container enrolment-target-card">
    ...
    <div className="enrolment-target-copy">
      ...
      <p>The target starts when Aptenvo has received successful payment and complete, accurate learner information. Sundays and UK public bank holidays observed by Aptenvo do not count, including Christmas and New Year public bank holidays and substitute days.</p>
      <div className="enrolment-target-points">
        ...
        <span><ShieldCheck size={16} /> Aptenvo remains the support contact</span>
      </div>
    </div>
    <div className="enrolment-target-action"><Mail size={22} /><p>Waiting beyond the target?</p><Link className="button button-secondary" to="/contact?topic=order-enrolment">Contact Aptenvo</Link></div>
  </div></section>;
}
