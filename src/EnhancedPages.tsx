...
export function EnhancedAboutPage() {
  return <main>
    <PageHero
      eyebrow="About Aptenvo"
      title="A clear route from choosing training to starting learning"
      copy="Aptenvo is the online-training service operated by JA Group Services Ltd. We sell, administer and support Highfield Online Training courses for adult individuals and organisations."
    />
    ...
    <section className="section"><div className="container about-introduction-grid">
      <article className="about-story-card">
        ...
        <p>Aptenvo was created to make purchasing workplace and professional online training easier to understand. Customers can compare courses, read who each course is intended for, combine different licences in one basket and provide the learner information needed for enrolment.</p>
        <p>JA Group Services Ltd, trading through Aptenvo, is an authorised reseller of Highfield Online Training. Aptenvo is the seller, account provider and customer-facing service. Highfield supplies the course content and operates the Learning Management System used by enrolled learners.</p>
        <div className="about-principle"><ShieldCheck size={24} /><div><strong>You remain an Aptenvo customer</strong><span>Using the Highfield Learning Management System does not transfer your order, account, support or complaint relationship to Highfield.</span></div></div>
      </article>
      <aside className="about-operator-card">
        <Building2 size={32} />
        <span>Legal operator</span>
        <h2>JA Group Services Ltd</h2>
        <p>Aptenvo is a trading division and service of JA Group Services Ltd, not a separate legal entity.</p>
        <dl>
    ...
    <section className="section section-muted"><div className="container">
      <div className="section-heading"><span>What Aptenvo does</span><h2>More than a link to somebody else’s course</h2><p>Aptenvo manages the commercial and customer journey around the training—from course selection to enrolment support.</p></div>
      <div className="enhanced-feature-grid">
        ...
        <InfoTile icon={<FileCheck2 size={24} />} title="Ordering and payment" copy="Aptenvo provides the basket, confirms licence quantities, records learner details and processes the customer’s payment through Stripe." />
        <InfoTile icon={<GraduationCap size={24} />} title="Learner enrolment" copy="After a successful purchase, Aptenvo checks the learner information and enrols each named learner onto the correct course." />
        <InfoTile icon={<Headphones size={24} />} title="First-line support" copy="Customers contact Aptenvo first for order, enrolment, access and course issues. We investigate and manage any necessary provider escalation." />
      </div>
    </div></section>

    <section className="section"><div className="container about-journey-section">
      <div className="section-heading"><span>How fulfilment works</span><h2>Purchase through Aptenvo. Learn through Highfield.</h2><p>The businesses have distinct roles, but the customer only needs one customer-facing point of contact.</p></div>
      <div className="about-journey-grid">
        <article><span>01</span><h3>Choose and purchase</h3><p>The customer chooses the course and buys from JA Group Services Ltd through Aptenvo.</p></article>
        <article><span>02</span><h3>Aptenvo validates the order</h3><p>We confirm payment, learner names, enrolment email addresses and the course licences purchased.</p></article>
        <article><span>03</span><h3>Aptenvo enrols learners</h3><p>The information required for delivery is provided to Highfield so the correct LMS course access can be created.</p></article>
        ...
        <article><span>05</span><h3>Aptenvo remains available</h3><p>The customer contacts Aptenvo for help. Provider-side matters are escalated by us rather than passed back to the customer.</p></article>
      </div>
    </div></section>

    <section className="section section-muted"><div className="container about-standards-grid">
      <article className="about-standard-card"><UserCheck size={27} /><h2>Adults only</h2><p>Aptenvo is an 18+ service. We do not accept purchases from, or sell courses to, anybody under the age of 18. The purchaser must confirm that they meet the minimum age requirement.</p></article>
      <article className="about-standard-card"><Users size={27} /><h2>Licence limits</h2><p>Up to 25 course licences may be purchased in one public online basket. Requirements for 26 licences or more must be arranged directly with Aptenvo and must not be divided into smaller online orders.</p></article>
...
const helpArticles: HelpArticle[] = [
  {
    ...
    summary: 'Highfield sends LMS access after Aptenvo has completed enrolment. The message may be delayed or filtered by the receiving email service.',
    steps: [
      'Check the inbox and spam, junk, promotions and quarantine folders for a Highfield email.',
      'Search the mailbox for “Highfield” and confirm that the email address provided to Aptenvo is correct.',
      'Allow reasonable enrolment-processing time after payment. A payment receipt is not the LMS access email.',
      'Contact Aptenvo with the order reference and learner email if access has still not arrived. Do not contact Highfield directly.',
    ],
  ...
  },
  {
    ...
    steps: [
      'Open the Highfield enrolment email sent to the learner address supplied during the Aptenvo purchase.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Contact Aptenvo if no reset email arrives or the account cannot be identified. We will check the enrolment and escalate where necessary.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Record the course title, module and page where the issue occurs, then contact Aptenvo if it remains blocked.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Contact Aptenvo with screenshots, the device, browser, network type, course title and affected module. We will investigate and manage any Highfield escalation.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Contact Aptenvo if the issue continues and include the iPad model, iPadOS version and course title.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Contact Aptenvo if every module appears complete but the assessment remains locked.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Contact Aptenvo if the course is complete but no certificate is available, or if the certificate details are incorrect.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Contact Aptenvo with the order reference, incorrect information and the correct legal first name, legal last name or enrolment email.',
      'Aptenvo will check the customer authority and update the information where possible.',
      'Where the provider must make the correction, Aptenvo will raise and manage that request with Highfield.',
    ],
    ...
    {largeOrder ? <section className="section"><div className="container large-order-help-card"><Users size={40} /><div><h2>Contact Aptenvo before purchasing</h2><p>Public checkout is limited to 25 licences in total. Do not divide a larger requirement into several online orders. Include the organisation or purchaser name, course titles, licence quantities and preferred timeframe.</p><a className="button button-primary" href={`mailto:${CONTACT_EMAIL}?subject=${encodeURIComponent('Aptenvo large licence order')}`}>Email the large-order team</a></div></div></section> : <>
      <section className="section help-search-section"><div className="container">
        ...
        <div className="help-start-cards">
          ...
          <InfoTile icon={<Headphones size={23} />} title="Still need help?" copy="Contact Aptenvo with the order reference and learner email. We will manage any provider escalation." />
        </div>
      </div></section>

      <section className="section section-muted"><div className="container help-article-layout">
        <div><div className="section-heading left"><span>Self-service guidance</span><h2>{filtered.length} help {filtered.length === 1 ? 'article' : 'articles'}</h2><p>These steps are adapted for Aptenvo customers from the learner guidance used with the Highfield Learning Management System.</p></div>
          <div className="help-article-list">
            {filtered.length ? filtered.map((article) => <details className="help-article" key={article.id} id={article.id}>
              ...
              <div className="help-article-content"><ol>{article.steps.map((step) => <li key={step}>{step}</li>)}</ol><div className="help-contact-reminder"><Headphones size={19} /><p><strong>Contact Aptenvo if the issue remains.</strong> Include screenshots and exact error wording where possible. Do not send passwords or full payment-card details.</p></div></div>
            </details>) : <div className="empty-help-results"><Search size={30} /><h3>No matching help article</h3><p>Try a shorter search, or contact Aptenvo and describe the problem.</p></div>}
          </div>
        </div>
        <aside className="help-contact-card"><Headphones size={31} /><span>Aptenvo first-line support</span><h2>Need us to investigate?</h2><p>Tell us the customer name, order reference, learner email, course title, device or browser and what happened immediately before the issue.</p><a className="button button-primary full-width" href={`mailto:${CONTACT_EMAIL}?subject=${encodeURIComponent('Aptenvo learner support')}`}>Email {CONTACT_EMAIL}</a><div><ShieldCheck size={18} /><span>You do not need to contact Highfield. Aptenvo will manage any required escalation.</span></div></aside>
      </div></section>
    </>}

    <section className="section"><div className="container support-priority-section">
      <div className="section-heading left"><span>Support service levels</span><h2>How Aptenvo prioritises support requests</h2><p>Aptenvo assigns a priority using its reasonable assessment of severity, impact and the ability of customers or learners to continue using the service.</p></div>
      ...
      <div className="priority-notes">
        <div><Clock3 size={20} /><p><strong>Working time.</strong> Targets are measured during Aptenvo’s published support working hours. We will acknowledge, investigate and communicate proportionately to the assigned priority.</p></div>
...
export function RefundPolicyPage() {
  return <main>
    <PageHero eyebrow="Refunds and cancellation" title="How cancellation changes when digital course access begins" copy="Aptenvo reviews refund requests fairly, but access to immediately supplied digital training changes the normal change-of-mind position." />
    <section className="section"><div className="container refund-layout">
      <article className="refund-main-card">
        ...
        <p>Contact Aptenvo as soon as possible if you made a mistake or no longer require a course. Where enrolment and digital access have not been activated, we will review cancellation and refund eligibility in line with the customer’s statutory rights, the order status and the applicable terms.</p>

        <h2>Once access is activated or learning starts</h2>
        <p>A change-of-mind refund is not available once Aptenvo has arranged activation of the digital course or the learner has begun accessing the learning, where the customer expressly requested immediate supply and acknowledged that the cancellation right would be lost when supply began.</p>
        ...
        <p>Nothing in this policy removes legal rights where digital content or services are faulty, not as described, not supplied with reasonable care and skill, or otherwise fail to meet statutory requirements. Depending on the circumstances, Aptenvo may investigate correction, re-performance, replacement access, a price reduction or another remedy required by law.</p>

        <h2>Duplicate purchases and incorrect learner details</h2>
        <p>Report duplicate payments, an incorrect course selection or incorrect learner information immediately. Do not begin the course while the request is under review. Aptenvo will check the Stripe payment, order, enrolment and provider status before confirming the available options.</p>

        <h2>How to request a review</h2>
        <p>Email Aptenvo with the order reference, purchaser name, learner email, course title, reason for the request and whether any LMS access email has been received or used. Do not send a password or full payment-card number.</p>
        <a className="button button-primary" href={`mailto:${CONTACT_EMAIL}?subject=${encodeURIComponent('Aptenvo refund review')}`}>Request a refund review</a>
      </article>
      <aside className="refund-side-card"><ShieldCheck size={30} /><h2>Your statutory rights remain protected</h2><p>The no-change-of-mind position after activation does not exclude remedies that the law requires for faulty, misdescribed or improperly supplied digital content or services.</p><ul><li><Check size={17} /> Contact Aptenvo, not Highfield</li><li><Check size={17} /> Each request is checked against the actual order status</li><li><Check size={17} /> Provider-side evidence is obtained by Aptenvo where needed</li><li><Check size={17} /> Complaints and escalation remain available</li></ul><Link to="/complaints">Read the complaints route <ArrowRight size={16} /></Link></aside>
    </div></section>
  </main>;
}
