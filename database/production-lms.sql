...
-- Sousa Murray eLearning production Learning Library schema.
-- This schema is separate from the Highfield professional-training order tables.
...
INSERT INTO lms_plans (id, name, description, amount_pence, seat_limit, library_tier, display_order)
VALUES
  ('learner', 'Learner', 'Unlimited access to the core Sousa Murray Learning Library for one named learner.', 999, 1, 'core', 10),
  ('learner-plus', 'Learner Plus', 'Unlimited access to the complete Sousa Murray Learning Library for one named learner.', 1699, 1, 'complete', 20),
  ('team-5', 'Team 5', 'Complete Learning Library access for up to five named learners.', 3999, 5, 'complete', 30),
  ('team-15', 'Team 15', 'Complete Learning Library access for up to fifteen named learners.', 8999, 15, 'complete', 40)
